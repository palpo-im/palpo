                    ...
                    div { class: "mt-4 flex space-x-4",
                        ...
                        div { class: "w-48",
                            Select {
                                ...
                                options: vec![
                                    ("all".to_string(), "所有配置节".to_string(), None),
                                    ("server".to_string(), "服务器配置".to_string(), None),
                                    ("database".to_string(), "数据库配置".to_string(), None),
                                    ("federation".to_string(), "联邦配置".to_string(), None),
                                    ("auth".to_string(), "认证配置".to_string(), None),
                                    ("media".to_string(), "媒体配置".to_string(), None),
                                    ("network".to_string(), "网络配置".to_string(), None),
                                    ("logging".to_string(), "日志配置".to_string(), None),
                                ],
        ...
        div { class: "space-y-6",
            ...
            if matches_search("日志级别", Some("日志记录的详细程度"), &search_query) {
                Select {
                    ...
                    options: vec![
                        ("Debug".to_string(), "Debug".to_string(), None),
                        ("Info".to_string(), "Info".to_string(), None),
                        ("Warn".to_string(), "Warn".to_string(), None),
            ...
            if matches_search("日志格式", Some("日志输出的格式"), &search_query) {
                Select {
                    ...
                    options: vec![
                        ...
                        ("Pretty".to_string(), "Pretty".to_string(), None),
                        ("Compact".to_string(), "Compact".to_string(), None),
