...
impl HomeServerResBody {
    /// Creates a new `HomeServerResBody` with the given `HomeserverInfo`.
...
#[derive(ToSchema, Clone, Debug, Deserialize, Hash, Serialize, PartialEq, Eq)]
